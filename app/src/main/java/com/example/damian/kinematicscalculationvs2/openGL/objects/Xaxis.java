...
public class Xaxis extends ObjectParent{

    public Xaxis(float length) {
...
//        };
        ...
        verticles = new float[]{
                ...
                0.1f+length, -0.1f, 0.1f,  // 1. right-bottom-front
                -0.1f, 0.1f, 0.1f,  // 2. left-top-front
                0.1f+length, 0.1f, 0.1f ,  // 3. right-top-front
                0.1f+length, -0.1f, -0.1f,  // 6. right-bottom-back
                -0.1f, -0.1f, -0.1f,  // 4. left-bottom-back
                0.1f+length, 0.1f, -0.1f,  // 7. right-top-back
                -0.1f, 0.1f, -0.1f,  // 5. left-top-back
        };
