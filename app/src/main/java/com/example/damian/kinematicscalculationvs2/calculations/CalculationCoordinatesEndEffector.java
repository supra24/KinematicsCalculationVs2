package com.example.damian.kinematicscalculationvs2.calculations;
...
public class CalculationCoordinatesEndEffector {
    ...
    public CalculationCoordinatesEndEffector(float[][] tableParameters, float[] coordinatesEffector) {
        this.tableParameters = tableParameters;
        this.coordinatesEffector = coordinatesEffector;
    }
